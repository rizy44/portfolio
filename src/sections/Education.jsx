    ...
    <section id="education" className="relative py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="flex flex-col overflow-hidden rounded-xl border border-slate-800/60 bg-slate-900/50 sm:flex-row sm:items-center sm:gap-8"
        >
          <div className="flex shrink-0 items-center justify-center border-b border-slate-800/40 bg-white p-8 sm:border-b-0 sm:border-r sm:py-12">
            <img
          ...
          <div className="flex-1 p-6 sm:p-8">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-slate-400">
              <span>
                GPA: <span className="font-semibold text-white">8.6/10</span>{' '}
